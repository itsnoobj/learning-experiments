...
/**
 * Canonical quiz schema (single source of truth).
 *
 * Both the runtime content loader and the app's TypeScript types derive from
 * these Zod schemas, so validation and types can never drift apart. Types are
 * inferred with `z.infer` rather than hand-written.
 */
